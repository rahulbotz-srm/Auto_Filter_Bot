...
PICS = (environ.get('PICS', 'https://envs.sh/rWV.jpg')).split() 
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002595455756').split()] #Movie Database Channel Id
